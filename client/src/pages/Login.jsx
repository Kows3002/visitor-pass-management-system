...
export default function Login() {
  ...
  return <main className="access-login">
    ...
    <section className="access-form-side" aria-labelledby="login-title"><div className="access-form-wrap">
      ...
      <header className="access-form-heading"><span>Account enabled</span><h2 id="login-title">Sign in to your workspace</h2><p>Enter your company-issued credentials to continue.</p></header>
